...
public class ChatAdapter extends RecyclerView.Adapter<ChatItemPresenter> {
    ...
    public ChatAdapter(com.microsoft.office.sfb.appsdk.Conversation conversation) {
    ...
    public ChatItemPresenter onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        CardView cardView = (CardView) LayoutInflater.from(parent.getContext()).inflate(R.layout.chat_list_item, parent, false);
    ...
    public void onBindViewHolder(ChatItemPresenter holder, final int position) {
        ...
        switch (activityType) {
            ...
            case PARTICIPANTLEFT:
                ...
                String activityString = (activityType == ConversationActivityItem.ActivityType.PARTICIPANTJOINED) ? " Joined" : " Left";
